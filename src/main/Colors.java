...
public class Colors extends EV3ColorSensor {
	...
	public void initColors() {
		 ...
		 * 
		 * LCD.drawString("Press enter to calibrate red...",1,1);
		 * Button.ENTER.waitForPressAndRelease(); red = new
		 * float[view.sampleSize()]; view.fetchSample(red, 0);
		 * LCD.drawString("Red calibrated",1,1);
		 * 
		 * LCD.drawString("Press enter to calibrate green...",1,1);
		 * Button.ENTER.waitForPressAndRelease(); green = new
		 * float[view.sampleSize()]; view.fetchSample(green, 0);
		 * LCD.drawString("Green calibrated",1,1);
		 * 
		 * LCD.drawString("Press enter to calibrate black...",1,1);
		 * Button.ENTER.waitForPressAndRelease(); black = new
		 * float[view.sampleSize()]; view.fetchSample(black, 0);
	...
	public void getColor() {
		...
		try {
			...
			red[0] = Float.parseFloat(br.readLine());
			red[1] = Float.parseFloat(br.readLine());
			red[2] = Float.parseFloat(br.readLine());
			blue[0] = Float.parseFloat(br.readLine());
			blue[1] = Float.parseFloat(br.readLine());
			blue[2] = Float.parseFloat(br.readLine());
			green[0] = Float.parseFloat(br.readLine());
			green[1] = Float.parseFloat(br.readLine());
			green[2] = Float.parseFloat(br.readLine());
			black[0] = Float.parseFloat(br.readLine());
			black[1] = Float.parseFloat(br.readLine());
			black[2] = Float.parseFloat(br.readLine());
			white[0] = Float.parseFloat(br.readLine());
			white[1] = Float.parseFloat(br.readLine());
			white[2] = Float.parseFloat(br.readLine());
			br.close();
	...
	public boolean depassementBlanc() {
		getColor();
		return colorDetected == "white";
	}
